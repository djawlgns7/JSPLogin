package signupPro.mgr;

import signupPro.bean.MemberBean;
...
import static signupPro.mgr.DBConnectionMgr.close;
import static signupPro.mgr.DBConnectionMgr.getConnection;
...
public class MemberMgr {
    ...
    public void updateMember(MemberBean member){
        String sql = "update member set pwd = ?, name = ?, gender = ?, email = ?, birth = ?, zipcode = ?," +
